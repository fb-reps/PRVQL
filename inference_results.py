...
if __name__ == '__main__':
    ...
    annotation_path = os.path.join('/mnt/DATA-1/bingfanprojects/datasets/VQ2D/episodic-memory/VQ2D/datav2', 'vq_{}.json'.format(mode))
    ...
    #     file.write("smoothing_sigma"+str(config.inference.smoothing_sigma)+"\n")
    #     file.write("peak_score_threshold"+str(config.inference.peak_score_threshold)+"\n")
    #     file.write("peak_window_threshold"+str(config.inference.peak_window_threshold)+"\n")